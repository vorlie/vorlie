...
import Buttons88x31 from "../Buttons88x31";

export default function AboutSection() {
  return (
    <section id="about" className="min-h-screen py-16" aria-labelledby="about-heading">
      <motion.div
      ...
      >
        <div className="text-center mb-10">
          <h2 id="about-heading" className="text-4xl sm:text-5xl font-black text-m3-on-surface tracking-tighter mb-4">
            About
          </h2>
