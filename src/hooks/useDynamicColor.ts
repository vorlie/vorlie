    ...
    img.onload = () => {
      try {
        ...
        root.style.setProperty(
          "--color-m3-surface",
          hexFromArgb(systemDark.surface),
        );
        root.style.setProperty(
          "--color-m3-surface-container",
          hexFromArgb(systemDark.secondaryContainer),
        );
        root.style.setProperty(
          "--color-m3-surface-variant",
          hexFromArgb(systemDark.surfaceVariant),
        );
        root.style.setProperty(
          "--color-m3-primary",
          hexFromArgb(systemDark.primary),
        );
        root.style.setProperty(
          "--color-m3-on-primary",
          hexFromArgb(systemDark.onPrimary),
        );
        root.style.setProperty(
          "--color-m3-primary-container",
          hexFromArgb(systemDark.primaryContainer),
        );
        root.style.setProperty(
          "--color-m3-on-primary-container",
          hexFromArgb(systemDark.onPrimaryContainer),
        );
        root.style.setProperty(
          "--color-m3-secondary",
          hexFromArgb(systemDark.secondary),
        );
        root.style.setProperty(
          "--color-m3-on-secondary",
          hexFromArgb(systemDark.onSecondary),
        );
        root.style.setProperty(
          "--color-m3-outline",
          hexFromArgb(systemDark.outline),
        );
        root.style.setProperty(
          "--color-m3-on-surface",
          hexFromArgb(systemDark.onSurface),
        );
        root.style.setProperty(
          "--color-m3-on-surface-variant",
          hexFromArgb(systemDark.onSurfaceVariant),
        );
