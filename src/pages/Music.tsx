                ...
                {nowPlaying?.isPlaying && (
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundColor:
                          albumColors?.primary || "var(--color-m3-primary)",
                      }}
                    ></div>
              ...
              {recentTracks.slice(1, 7).map((track, i) => (
                ...
                >
                  <img
                    src={track.image}
                    alt={track.name}
                    className="w-16 h-16 rounded-[16px] object-cover shadow-md transition-transform group-hover:scale-105"
                  />
                  <div className="flex-grow min-w-0">
                    <p
                      ...
                      onMouseEnter={(e) =>
                        albumColors &&
                        (e.currentTarget.style.color = albumColors.primary)
                      }
                      onMouseLeave={(e) =>
                    ...
                    <p className="text-sm font-bold text-m3-on-surface-variant opacity-60 truncate">
                      {track.artist}
                    </p>
                  </div>
                </a>
          ...
          <section>
            <h3
              ...
              style={{
                color: "var(--color-m3-on-surface)",
                borderColor:
                  albumColors?.primary || "var(--color-m3-secondary)",
              }}
            >
              Top Artists
            </h3>
            <div className="grid grid-cols-2 gap-6">
              {topArtists.map((artist, i) => (
                ...
                >
                  <div
                    className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden shadow-lg border-2"
                    style={{
                      borderColor: albumColors?.primary
                        ? `${albumColors.primary}33`
                        : "rgba(var(--color-m3-primary), 0.2)",
