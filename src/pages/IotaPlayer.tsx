  ...
  return (
    <div className="flex flex-col gap-12 max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-m3-on-surface">
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        <section className="lg:w-2/3 flex flex-col gap-10">
          ...
          <div className="bg-m3-surface-container rounded-[32px] p-8 sm:p-12 shadow-sm border border-m3-outline/10">
            <h1 className="text-5xl sm:text-6xl font-black mb-8 text-m3-primary tracking-tight">Iota Player</h1>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8">
              ...
              <div className="text-m3-on-surface-variant font-medium">
                <p className="text-sm opacity-80 mb-1">One-command installer script.</p>
                <a href="#installation" className="text-m3-primary font-bold hover:underline flex items-center gap-1">
          ...
          <div className="bg-m3-surface-container rounded-[32px] p-8 sm:p-12 border border-m3-outline/5">
            ...
            <div className="grid gap-12">
              <div className="group">
                <h3 className="text-xl font-black text-m3-primary mb-3">Playlist Management</h3>
                <p className="text-m3-on-surface-variant font-medium text-lg leading-relaxed">
                  Utilize the dedicated <a href="https://github.com/vorlie/IotaPlayer/blob/main/README.md#playlist-maker" target="_blank" rel="noopener noreferrer" className="text-m3-primary hover:underline font-bold">Playlist Maker</a> to build or modify playlists. Combine songs from multiple sources into a single, unified playlist with ease.
                </p>
              </div>

              <div className="group">
                <h3 className="text-xl font-black text-m3-primary mb-3">Audio Controls</h3>
                <p className="text-m3-on-surface-variant font-medium text-lg leading-relaxed mb-4">
                  Comprehensive playback including repeat, shuffle, and a draggable seek bar. Built on native <code className="bg-m3-surface px-3 py-1.5 rounded-xl text-m3-primary font-black text-sm border border-m3-outline/10">QMediaPlayer</code> for maximum stability.
                </p>
              </div>

              <div className="group">
                <h3 className="text-xl font-black text-m3-primary mb-4">Platform Integration</h3>
                <div className="flex flex-wrap gap-3">
                  {['Discord RPC', 'YouTube Upload', 'Linux MPRIS', 'Google API'].map(tag => (
                    <span key={tag} className="bg-m3-primary/10 text-m3-primary px-4 py-1.5 rounded-full text-sm font-black border border-m3-primary/20 tracking-tight uppercase">
                      {tag}
                    </span>
                  ))}
                </div>
            ...
            <div className="flex flex-col gap-10">
              <div className="p-8 bg-m3-surface-variant/10 rounded-[28px] border border-m3-outline/5 hover:border-m3-outline/20 transition-all duration-300">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-m3-primary text-m3-on-primary rounded-2xl flex items-center justify-center font-black text-xl shadow-md">L</div>
                  <h3 className="text-2xl font-black text-m3-primary">Linux (Recommended)</h3>
                </div>
                <p className="text-m3-on-surface-variant font-medium text-lg mb-8 leading-relaxed">
                  The <code className="bg-m3-surface px-2 py-1 rounded-lg text-m3-primary font-bold">linux_installer.sh</code> script automates the entire setup process.
                </p>
                <div className="space-y-6">
                  <div className="bg-m3-surface rounded-2xl p-6 border border-m3-outline/10 relative overflow-hidden group">
                    ...
                    <p className="text-xs text-m3-on-surface-variant font-black uppercase tracking-widest mb-3 opacity-60">1. Download Script</p>
                    <code className="text-sm sm:text-base font-bold text-m3-on-surface break-all block">curl -O https://raw.githubusercontent.com/vorlie/IotaPlayer/master/linux_installer.sh</code>
                  </div>
                  <div className="bg-m3-surface rounded-2xl p-6 border border-m3-outline/10 relative overflow-hidden group">
                    <div className="absolute top-0 left-0 w-1 h-full bg-m3-primary/50 group-hover:bg-m3-primary transition-colors"></div>
                    <p className="text-xs text-m3-on-surface-variant font-black uppercase tracking-widest mb-3 opacity-60">2. Run Installer</p>
                    <code className="text-sm sm:text-base font-bold text-m3-on-surface block">chmod +x linux_installer.sh && ./linux_installer.sh install</code>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 bg-m3-surface-variant/10 rounded-[28px] border border-m3-outline/5 hover:border-m3-outline/20 transition-all duration-300">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-m3-primary text-m3-on-primary rounded-2xl flex items-center justify-center font-black text-xl shadow-md">W</div>
                  <h3 className="text-2xl font-black text-m3-primary">Windows</h3>
                </div>
                <p className="text-m3-on-surface-variant font-medium text-lg mb-8 leading-relaxed">
                  Simply download the standalone <code className="bg-m3-surface px-2 py-1 rounded-lg">.exe</code> from the releases page and launch it.
                </p>
                <a
        ...
        <aside className="lg:w-1/3 flex flex-col gap-8">
          ...
          <div className="bg-m3-surface-container rounded-[32px] p-8 border border-m3-outline/10 shadow-sm">
            <h2 className="text-2xl font-black mb-6 text-m3-on-surface tracking-tight">About Project</h2>
            ...
            <div className="flex flex-col gap-4">
               {['PyQt6', 'GStreamer', 'Discord RPC'].map(tech => (
                 <div key={tech} className="flex items-center gap-3">
                   ...
                   <span className="font-bold text-sm text-m3-on-surface-variant">{tech}</span>
                 </div>
               ))}
            </div>
          </div>
          ...
          <div className="bg-m3-surface-container rounded-[32px] p-8 border border-m3-outline/10 shadow-sm overflow-hidden">
            <h2 className="text-2xl font-black mb-6 text-m3-on-surface tracking-tight">Gallery</h2>
            <div className="flex flex-col gap-6">
              {[
                ...
                <div key={img.path} className="group relative bg-m3-surface rounded-[24px] overflow-hidden border border-m3-outline/5 hover:border-m3-outline/30 transition-all shadow-sm hover:shadow-xl">
                  <div className="p-3">
                    <p className="text-xs font-black uppercase tracking-widest text-m3-on-surface-variant mb-3 group-hover:text-m3-primary transition-colors">{img.name}</p>
                    <div className="relative overflow-hidden rounded-[16px]">
                      ...
                      <div className="absolute inset-0 bg-m3-primary/20 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none flex items-center justify-center">
                         <div className="bg-m3-surface/90 p-3 rounded-full shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-transform">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-m3-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-m3-surface-container/40 rounded-[32px] p-8 border border-m3-outline/5">
            <div className="flex flex-col gap-4 font-black text-sm uppercase tracking-tighter">
              <a href="https://github.com/vorlie/IotaPlayer/blob/main/LICENSE" className="flex items-center justify-between text-m3-on-surface-variant hover:text-m3-primary transition-colors group">
                License <span className="opacity-0 group-hover:opacity-100 transition-opacity">GPL 3.0</span>
              </a>
              <a href="https://github.com/vorlie/IotaPlayer" className="flex items-center justify-between text-m3-on-surface-variant hover:text-m3-primary transition-colors group">
                Source <span className="opacity-0 group-hover:opacity-100 transition-opacity">GitHub</span>
              </a>
              <a href="https://github.com/users/vorlie/projects/3/views/1" className="flex items-center justify-between text-m3-on-surface-variant hover:text-m3-primary transition-colors group">
                To-Do <span className="opacity-0 group-hover:opacity-100 transition-opacity">Roadmap</span>
              </a>
            </div>
          </div>
        </aside>
      ...
      <div className="bg-m3-surface-container rounded-[32px] p-10 border border-m3-outline/10 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <h3 className="text-xl font-black mb-2 text-m3-on-surface">Acknowledgments</h3>
          <p className="text-m3-on-surface-variant font-medium">Built with PyQt6, qdarktheme, pypresence, and mutagen.</p>
        </div>
        <div className="text-right">
          <p className="text-sm font-black text-m3-on-surface-variant uppercase tracking-[0.2em] opacity-30">© {new Date().getFullYear()} vorlie</p>
        </div>
      </div>
